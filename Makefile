...
srcs += xft/color xft/dbg xft/xftdpy xft/xftdraw xft/xftextent xft/xftfont xft/xftfreetype xft/xftglyphs xft/xftinit xft/xftlist xft/xftrender xft/xftstr xft/xftswap
srcs := $(srcs:=.c)
